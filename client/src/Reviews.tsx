...
const Reviews = () => {
  ...
  return (<>
      ...
      <div className="reviews-list">
        ...
        <h4 className="review-author">Александра</h4>
        ...
        <blockquote className="review-item">
        <h4 className="review-author">Елизавета </h4>
          <p className="description">
        ...
        <blockquote className="review-item">
        <h4 className="review-author">Алина </h4>
          <p className="description">
        ...
        <blockquote className="review-item">
        <h4 className="review-author">Ия </h4>
          <p className="description">
        ...
        <blockquote className="review-item">
        <h4 className="review-author">Евгения </h4>
          <p className="description">
        ...
        <blockquote className="review-item">
        <h4 className="review-author">Ольга</h4>
          <p className="description">
